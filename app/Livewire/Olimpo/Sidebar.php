    ...
    public function mount()
    {
        $svg = function($p) {
            $icons = [
                ...
                'reportes' => '<svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>',
                'graficos' => '<svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"/></svg>',
        ...
        $this->navItems = [
            ...
            ['key' => 'reportes', 'label' => 'Reportes', 'svg' => $svg('reportes'), 'route' => 'olimpo.reportes'],
            ...
            ['key' => 'graficos', 'label' => 'Gráficos', 'svg' => $svg('graficos'), 'route' => 'olimpo.graficos'],
        ...
        foreach ($this->navItems as $item) {
            if ($item['route'] === $currentRoute) {
                $this->activePanel = $item['key'];
                break;
            }
        }
    }

    protected $listeners = ['panelChanged' => 'updatePanel'];
